 ...
 * Cart page.
 *
 * Adapted from woocommerce/templates/cart/cart.php — same cart-item loop,
 * hooks, and form fields (required for quantity-update / remove-item AJAX
 * and coupon handling to keep working), restyled to the token system.
 *
...
<form class="woocommerce-cart-form cart-page" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				<th class="product-remove"><span class="visually-hidden"><?php esc_html_e( 'Remove item', 'woocommerce' ); ?></span></th>
				<th class="product-thumbnail"><span class="visually-hidden"><?php esc_html_e( 'Thumbnail', 'woocommerce' ); ?></span></th>
				...
				<td colspan="6" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) : ?>
						<div class="coupon">
							...
							<button type="submit" class="btn btn--outline" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
							<?php do_action( 'woocommerce_cart_coupon' ); ?>
						</div>
					<?php endif; ?>

					<button type="submit" class="btn btn--outline" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
