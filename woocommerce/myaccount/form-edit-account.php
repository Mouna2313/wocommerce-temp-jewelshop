<?php
/**
 * Account details form (name, email, password change).
 *
 * Adapted from woocommerce/templates/myaccount/form-edit-account.php.
 *
...
<form class="woocommerce-EditAccountForm edit-account account-details-form" action="" method="post">
	...
	<fieldset class="account-details-form__password-fieldset">
		<legend><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'woocommerce' ); ?></label>
			<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password_current" id="password_current" autocomplete="off" />
		</p>
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
